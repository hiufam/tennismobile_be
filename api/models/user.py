...
class User(BaseModel):
    ...
    def validate_username(self, key, full_name):
        if self.is_verify == True and not full_name or not len(full_name) > 0:
    ...
    def validate_date_of_birth(self, key, date_of_birth):
        if self.is_verify == True and not date_of_birth:
    ...
    def validate_gender(self, key, gender):
        if self.is_verify == True and not gender:
    ...
    def validate_singles_skill(self, key, singles_skill):
        if self.is_verify == True and not singles_skill:
    ...
    def validate_doubles_skill(self, key, doubles_skill):
        if self.is_verify == True and not doubles_skill:
    ...
    def validate_avatar(self, key, avatar):
        if self.is_verify == True and not avatar:
